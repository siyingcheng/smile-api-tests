...
public class JsonPathConstant {
    ...
    public static final String DATA_ID_PATH = DATA_PATH + ".id";
    public static final String DATA_TOKEN_PATH = DATA_PATH + ".token";
    public static final String DATA_USERINFO_PATH = DATA_PATH + ".userInfo";
    public static final String DATA_USERNAME = DATA_PATH + ".username";
    public static final String DATA_NICKNAME = DATA_PATH + ".nickname";
